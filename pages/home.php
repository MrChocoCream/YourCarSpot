        ...
        <form id="cuadro" action="../php/buscar.php" method="post" class="mt-14 p-6 ">
            <div class="p-2 shadow-md ">
                <div class="flex justify-between items-center gap-6">
                    <span class="block text-3xl font-bold my-4  border-b-2 border-orange-300 relative ">Buscar Vehiculo</span>
                    <a href="/pages/busquedaasist.php" class="self-end flex gap-2 justify-center px-2 py-4 bg-orange-600 rounded-lg text-sm leading-normal font-semibold text-white">
                            <span>Te ayudamos a elegir tu vehiculo</span>
